<p id="credits">
Powered by <a href="http://www.blogofile.com">Blogofile</a> | RSS feeds for <a href="${bf.util.site_path_helper(bf.config.blog.path,'feed')}">Entries</a> | <a title="ave4yourmusic.com Sitemap" href="/sitemap.html">site map</a>
